...
class PreprocessingMixin:
    ...
    def _encode_text_feature(text_feat, model=None):
        if model is None:
            model = SentenceTransformer('/public/home/wangdj2/.cache/huggingface/hub/models--sentence-transformers--sentence-t5-xxl/snapshots/97f38f2f69860f732f602829da6df76ee5c4c0f9')
